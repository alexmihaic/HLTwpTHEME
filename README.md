...
Resumen breve de mejoras de la tercera iteración (enfocada en desktop):

- Layout general más amplio en escritorio con contenedores escalonados (hero/texto/grids/footer).
- Hero con composición más horizontal y presencia tipográfica superior en desktop.
- Tarjetas de servicios y proyectos más amplias, con mejor ritmo, padding y jerarquía visual.
- Footer reforzado con distribución más editorial y firma roja sutil.
- Breakpoints optimizados para 768px, 1024px, 1280px y 1440px sin romper móvil.
